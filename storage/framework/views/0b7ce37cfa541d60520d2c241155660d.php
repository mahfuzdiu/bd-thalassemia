            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background: #ffffff; padding: 20px; border-radius: 8px;">
                ...
                <tr>
                    <td style="text-align: center;">
                        ...
                        <p style="color: #555;">Your order status has been updated. Its status is <?php echo e($orderStatus); ?> at the moment</p>
                        <p>Order No: <?php echo e($orderNum); ?></p>
                    </td>
                </tr>
                <tr>
...
<?php /**PATH C:\wamp64\www\thalassemia\resources\views\emails\order_update.blade.php ENDPATH**/ ?>